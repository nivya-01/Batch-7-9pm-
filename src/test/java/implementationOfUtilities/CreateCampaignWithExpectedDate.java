...
//		driver.findElement(By.name("campaignStatus")).sendKeys("In progress");
		...
		WebElement expectedClosedate = cp.getExpCloseDate();//driver.findElement(By.name("expectedCloseDate"));
		wutil.passInput(driver, expectedClosedate, datereq);
		
		cp.getCreateCampSubmitBtn().click();//driver.findElement(By.xpath("//button[text()='Create Campaign']")).click();
		...
		cp.getClosemsg().click();//driver.findElement(By.xpath("//button[@aria-label='close']")).click();		
